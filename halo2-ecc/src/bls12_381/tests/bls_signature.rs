...
use halo2_base::{
    ...
    halo2_proofs::{
        halo2curves::{
            bls12_381::{multi_miller_loop_bls12_381, G2Prepared},
...
fn bls_signature_test<F: PrimeField>(
    ...
    let actual_result =
        multi_miller_loop_bls12_381(&[(&g1, &signature_g2_prepared), (&pubkey, &hash_m_prepared)])
...
fn test_bls_signature() {
    ...
    let debug_path = "halo2-ecc/configs/bls12_381/bls_signature_circuit.config";
    let path = run_path;
    // let path = debug_path;
...
//         create_proof::<
//             KZGCommitmentScheme<Bls12_381>,
//             ProverGWC<'_, Bls12_381>,
...
//         verify_proof::<
//             KZGCommitmentScheme<Bls12_381>,
//             VerifierGWC<'_, Bls12_381>,
//             Challenge255<G1Affine>,
//             Blake2bRead<&[u8], G1Affine, Challenge255<G1Affine>>,
//             SingleStrategy<'_, Bls12_381>,
